...
public class MyAdapter extends BaseAdapter{
   ...
   private Context context;
        private String[]shopStrings,serviceStrings,addressStrings,iconStrings;
    private ImageView imageView;
    private TextView shopTextView,serviceTextView,addressTextView;
